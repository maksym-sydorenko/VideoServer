...
namespace Interfaces.avi
{
    ...
    internal class AVIWriter : IDisposable
    {
        ...
        // Codec Video property
        public string CodecVideo
        {
            get { return codecVideo; }
            set { codecVideo = value; }
        }
        // Codec Audio property
        public string CodecAudio
        {
            get { return codecAudio; }
            set { codecAudio = value; }
        }
        // Quality property
        public int Quality
        {
        ...
        public void Open(string fname, int width, int height)
        {
            ...
            info.fccHandler = Win32.mmioFOURCC(codecVideo);
            info.dwScale = 1;
            info.dwRate = rate;
            ...
            opts.fccHandler = Win32.mmioFOURCC(codecVideo);
            opts.dwQuality =  quality;

            //
            //Win32.AVISaveOptions(stream, ref opts, IntPtr.Zero);
            //string sCodec = Win32.decode_mmioFOURCC(opts.fccHandler);
