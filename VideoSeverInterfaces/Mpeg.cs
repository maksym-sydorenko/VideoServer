        ...
        public override void WorkerThread()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    req = (HttpWebRequest)WebRequest.Create(cameraAdapter.ISourceAdaptee.UpdateSource());
                    // set login and password
                    if ((cameraAdapter.Login != null) && (cameraAdapter.ISourceAdaptee.Password != null) && (cameraAdapter.ISourceAdaptee.Login != ""))
                        req.Credentials = new NetworkCredential(cameraAdapter.ISourceAdaptee.Login, cameraAdapter.ISourceAdaptee.Password);
